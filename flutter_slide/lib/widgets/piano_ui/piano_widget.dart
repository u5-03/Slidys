...
import 'package:flutter_slide/widgets/piano_ui/aspect_ratio_constants.dart';
import 'package:flutter_slide/widgets/piano_ui/piano_key.dart';
import 'package:flutter_slide/widgets/piano_ui/piano_key_stroke.dart';
import 'package:flutter_slide/widgets/piano_ui/piano_key_widget.dart';
  ...
  void performLayout(Size size) {
    ...
    for (final pianoKey in pianoKeys) {
      ...
      if (pianoKey.isWhiteKey) {
        ...
        final blackKeyX =
            whiteKeyX - blackKeyWidth / 2 - keyMargin / 2 + blackKeyOffset;
