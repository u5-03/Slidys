...
struct SlideConfiguration: SlideConfigurationProtocol {
    let slideIndexController = SlideIndexController() {
        ...
        WebViewSlide(url: URL(string: "https://www.expo2025.or.jp/overview/character/")!)
        ...
        WebTitleSlide(title: "SymbolKit2 爆誕！", url: URL(string: "https://github.com/u5-03/SymbolKit")!)
