...
@Slide
struct LimitationsSlide: View, PhasedScriptProviding {
    ...
    var scriptSegments: [String] {
        ...
        "そして手首のトラッキングですが、たまにロストしますし、速い動きには追従が遅れ、カメラの死角に入ると止まります。",
        "また仮想の光は仮想のオブジェクトにしか当たらないので、現実の部屋は1ミリも明るくなりません。「部屋全体が光る」は原理的に再現できない。\n(ただWWDC26でPhysical Space Lightingが発表されたようなので、次期visionOSでは解消されているかもしれません。)",
        ]
    }
