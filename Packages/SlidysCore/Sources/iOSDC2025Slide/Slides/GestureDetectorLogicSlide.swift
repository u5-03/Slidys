                    ...
                    VStack(alignment: .leading, spacing: 15) {
                        ...
                        HStack(spacing: 20) {
                            VStack(alignment: .leading, spacing: 12) {
                                ConditionItem(icon: "hand.raised", text: "指の状態", detail: "isExtended/isCurled")
                                ConditionItem(icon: "arrow.up.and.down", text: "手の向き", detail: "palmDirection")
                            }
                            
                            VStack(alignment: .leading, spacing: 12) {
                                ConditionItem(icon: "angle", text: "関節角度", detail: "angleWithParent")
                                ConditionItem(icon: "ruler", text: "関節距離", detail: "jointToJointDistance")
                            }
                        }
                    }
